...
var (
	...
	textPlainCheck = regexp.MustCompile(`(?i:(?:text|text)/plain)`)
)

// APIClient manages communication with the Tencent Docs SDK API v0.0.1
...
type APIClient struct {
	...
	DriveAPIApi *DriveAPIApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.DriveAPIApi = (*DriveAPIApiService)(&c.common)
