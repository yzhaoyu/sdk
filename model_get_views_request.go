...
func (o GetViewsRequest) MarshalJSON() ([]byte, error) {
...
type NullableGetViewsRequest struct {
	value *GetViewsRequest
	isSet bool
}

func (v NullableGetViewsRequest) Get() *GetViewsRequest {
	return v.value
}

func (v *NullableGetViewsRequest) Set(val *GetViewsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGetViewsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGetViewsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetViewsRequest(val *GetViewsRequest) *NullableGetViewsRequest {
	return &NullableGetViewsRequest{value: val, isSet: true}
}

func (v NullableGetViewsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetViewsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
