...
func (r ApiDriveAPICreateFileRequest) Execute() (*DriveapiDriveAPIResponse1, *http.Response, error) {
...
//  @return DriveapiDriveAPIResponse1
func (a *DriveAPIApiService) DriveAPICreateFileExecute(r ApiDriveAPICreateFileRequest) (*DriveapiDriveAPIResponse1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DriveapiDriveAPIResponse1
	)
